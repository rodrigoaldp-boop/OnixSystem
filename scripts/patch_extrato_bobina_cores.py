    ...
    async function imprimirExtratoDividaContaReceber(contaId) {
      ...
      try {
        ...
        const html = [
          ...
          '<p class="hint">Empresa em <b style="color:#0056b3">azul</b>, cliente em <b>preto</b>, recebidos em azul, atrasos/juros/multa/saldo aberto em <b style="color:#c62828">vermelho</b>. Impressora termica pode sair so preto.</p>',
